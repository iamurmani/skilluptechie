        ...
        <div className='flex flex-col'>
            <div className='flex mt-20 gap-4 flex-col items-center flex-1 md:flex-row lg:mt-0'>
                ...
                <div className='flex-1 w-3/4'>
                    <Box component="form" className='flex flex-col gap-4 sm:w-3/4' onSubmit={handleSubmit(onLogin)}>
                        <h1 className='text-3xl font-bold'>Login to your Account</h1>
                        <p className='text-red-600 self-center'>{loginErr}</p>
                        <TextField label="Email" className='w-full rounded-sm' {...register('email')} helperText={errors.email?.message} error={errors.email ? true : false}/>
                        <TextField label="Password" className='w-full rounded-sm' {...register('password')} helperText={errors.password?.message} error={errors.password ? true : false}
                        ...
                        />
                        <a href="" className='self-end underline'>Forgot Password ?</a>
                        <Button variant="contained" endIcon={<ArrowForwardIosIcon />} className='w-full' type='submit'
                            sx={{
                                width: '100%',
